...
export const InitIMTable = {
    "createChatRecodeTable":"CREATE TABLE IF NOT EXISTS ChatRecode (Client varchar(255), Type varchar(255), LastMessage varchar(255),Time varchar(255),UnReadMessageNumber int)",
...
export const ExcuteIMSql = {
    ...
    "UpdateChatUnReadMessageaNumber":"update ChatRecode set UnReadMessageNumber = ? where Client = ?",
