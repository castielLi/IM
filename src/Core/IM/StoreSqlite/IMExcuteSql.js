...
export const InitIMTable = {
    ...
    "createMessageRecodeTable":"CREATE TABLE IF NOT EXISTS MessageRecode (Id INTEGER PRIMARY KEY AUTOINCREMENT,messageId varchar(255),send varchar(255), rec varchar(255) , time varchar(255), content varchar(255), type varchar(255), localPath varchar(255), resourceTime varchar(255), url varchar(255) , status varchar(255))",
    ...
    "CreateApplyFriendTable":"CREATE TABLE IF NOT EXISTS ApplyFriend (Id INTEGER PRIMARY KEY AUTOINCREMENT,send varchar(255), rec varchar(255) , status varchar(255), comment varchar(255), time varchar(255),key varchar(255),nick varchar(255),localImage varchar(255))",
...
export const ExcuteIMSql = {
    ...
    "InsertMessageToRecode":"insert into MessageRecode (messageId,send,rec,time,content,type,localPath,resourceTime,url,status) values (?,?,?,?,?,?,?,?,?,?)",
    ...
    "AddNewMessageToApplyFriend":"insert into ApplyFriend (send,rec,status,comment,time,key,nick,localImage) values(?,?,?,?,?,?,?,?)",
